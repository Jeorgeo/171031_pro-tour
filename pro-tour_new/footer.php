	...
	<div class="container footer__container">
		<section class="column-1">
			...
			<p>
				...
				Республика Беларусь, 231430, Гродненская обл., г.Кореличи, ул.Домейко, д.28<br>
		...
		<section class="column-4">
			...
			<article class="box-42">
				...
				<img src="<?bloginfo('template_url'); ?>/img/webpay.jpg" alt="Электронный эквайринг">
			</article>
		</section>
	</div>
	<section class="dark">
		<div class="container">
	      ...
	      Все права защищены. Перепечатка материалов разрешена только с указанием автора с активной ссылкой на сайт <a href="<?php echo get_permalink(47); ?>">PRO-tour.by</a><br>
				<a href="<?php echo get_permalink( 725 ); ?>">Политика конфиденциальности</a> Все предложения и цены на сайте носят информационный характер и не являются публичной афертой. Цены в иностранной валюте указаны справочно. Все расчеты на территории Республики Беларусь производятся исключительно в белорусских рублях.
	    </p>
			<p>
