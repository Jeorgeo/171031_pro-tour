<?php
add_action('init', 'register_post_types_ts');
function register_post_types_ts(){
	register_post_type('tabs', array(
		'label'  => 'tabs',
		'labels' => array(
			'name'               => 'Визы и страны', // основное название для типа записи
			...
			'menu_name'          => 'Визы и страны', // название меню
		),
		'description'         => '',
		'public'              => true,
