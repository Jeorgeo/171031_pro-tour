			...
			<section class="pay-box epos">
				...
				<ol>
					<li>
						...
						Уточните у нашего менеджера сумму за тур и оплатите через ЕРИП.
			...
			<section class="pay-box erip">
				...
				<p>
					<ul>
	    				...
	    				"Система "Расчёт" (ЕРИП) -> Туризм и отдых -> Турагентства, туроператоры ->  ПРО-ТУР -> Туристические услуги
						</li>
						<figure>
