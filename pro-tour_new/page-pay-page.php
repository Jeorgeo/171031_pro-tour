          ...
          <strong>Важно!</strong> Оплата производится только в белорусских рублях!
			...
			<section class="pay-box erip">
				...
				<p class="pay-descript">
					Оплатить туристичекие услуги турагентства "ПРО-ТУР" Вы можете через систему "Расчет" (ЕРИП) в любое удобное для Вас время, даже не выходя из дома.<br>
					Совершить оплату можно с использованием наличных денежных средств, электронных денег и банковских платежных карточек в пунктах банковского обслуживания банков, которые оказывают услуги по приему платежей, а также посредством инструментов дистанционного банковского обслуживания.Уточните у нашего менеджера сумму за тур и оплатите через ЕРИП.
					Для этого, в дереве ЕРИП, выберите сервис E-Pos и введите номер <strong>может выглядеть так: 10786-1-1613407453</strong>.
			...
			<section class="pay-box erip">
				...
				<p>
					...
					<ul>
						<li>
							<h4>Оплата туристических услуг онлайн без выставления персонального счета (по свободному реквизиту).</h4>
