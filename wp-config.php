...
define( 'WPCACHEHOME', 'Z:\home\pro-tour.ru\www\wp-content\plugins\wp-super-cache/' ); //Added by WP-Cache Manager
define('DB_NAME', 'yush25um_protour');

/** Имя пользователя MySQL */
define('DB_USER', 'yush25um_protour');

/** Пароль к базе данных MySQL */
define('DB_PASSWORD', 'Iu2QQ%90');
